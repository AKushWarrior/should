...
class NumModifier extends BaseShouldNum implements Modifier {
  @override
  ...
  NumModifier(this.modify, obj, parent, this.toStr) : super(obj, parent);
}

class PreNumModifier extends NumModifier {
  PreNumModifier(bool Function(bool p1) modify, obj, parent, toStr)
